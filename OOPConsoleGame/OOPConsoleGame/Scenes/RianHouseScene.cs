...
namespace OOPConsoleGame.Scenes
{
    public class RianHouseScene : BaseScene
    {
        ...
        public override void Result()
        {
            ...
            {
                case ConsoleKey.D1:
                    Console.WriteLine("\"북쪽 숲에는 오래된 폐허 말고는 아무것도 없어.\"");
                    Console.WriteLine("\"가끔 폐허 쪽에서 여자의 울음소리 같은게 들릴 때도 있지만\n분명 동물의 울음소리를 잘못 들은 거겠지.\"");
                    Util.Wait();
                    Console.Clear();
                    break;
                case ConsoleKey.D2:
                    Console.WriteLine("\"나도 함께 떠나자고?\"");
                    Console.WriteLine("\"너도 알다시피 우리 어머니가 아프셔서... 같이 떠나는건 무리야.\"");
                    Util.Wait();
                    Console.Clear();
                    break;
                case ConsoleKey.D3:
                    Console.WriteLine("당신은 작별인사를 마치고 리안의 집을 나와 광장으로 돌아갑니다.");
                    Util.Wait();
